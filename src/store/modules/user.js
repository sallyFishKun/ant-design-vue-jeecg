      ...
      return new Promise((resolve, reject) => {
        queryPermissionsByUser()
          .then(response => {
            ...
            //   route: '1',
            //   meta: {
            //     path: '/views/dashboard/Analysis',
            //     keepAlive: false,
            //     internalOrExternal: false,
            //     componentName: 'Analysis',
            //     title: '分析页'
            //   },
            //   name: 'views-dashboard-Analysis',
            //   id: '1939e035e803a99ceecb6f5563570bb11'
            // }
            const obj = {
              redirect: null,
              path: '/VUE_APP_SUB_start_hard',
              component: 'dashboard/Analysis2',
              route: '1',
              entry: '//localhost:8080',
              // activeRule: '/VUE_APP_SUB_jeecg-app-1',
              meta: {
                keepAlive: true,
                internalOrExternal: false,
                icon: 'dashboard',
                componentName: 'Analysis2',
                title: '首页2'
              },
